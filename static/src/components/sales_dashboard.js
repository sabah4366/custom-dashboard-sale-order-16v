...
export class OwlSalesDashboard extends Component {
        ...
        async getMonthlySales(){
            let domain = [['state','in',['draft','sale','sent','done']]]
            if (this.state.period > 0){
                domain.push(['date','>',this.state.current_date])
            }
...
//                    }
        ...
        async getOrders(){
            ...
            const revenue_percentage = ((current_revenue[0].amount_total - prev_revenue[0].amount_total) /
            prev_revenue[0].amount_total)*100
            ...
            const average_percentage = ((current_average[0].amount_total - prev_average[0].amount_total) /
            prev_average[0].amount_total)*100
